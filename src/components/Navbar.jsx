...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed top-0 bg-base-200 z-10 font-raleway text-primary">
    ...
    <div className="navbar-start flex items-center">
      <div className="dropdown">
        ...
        <ul
          ...
          <li><NavLink to={"/success"}>Success Section</NavLink></li>
      ...
      {/* Logo */}
      <div><img className="w-16 h-16 hidden md:block md:animate-spin" src={logo} alt="logo" /></div>
